...
//    public static final String RSA_ALGORITHM = "RSA/ECB/PKCS1Padding";
     ...
     * @return PrivateKey
     */
    public static PrivateKey getPvkformPfx(String filepath, String strPassword)
            throws Exception {
        PrivateKey prikey;
        char[] nPassword;
        ...
        KeyStore ks = getKsfilePath(filepath, strPassword);
        String keyAlias = getAlsformPfx(filepath, strPassword);
    ...
    public static KeyStore getKsformPfx(String strPfx, String strPassword)
        ...
        InputStream is = RSA.class.getClassLoader().getResourceAsStream(strPfx);
        char[] nPassword = null;
        if ((strPassword == null) || strPassword.trim().equals("")) {
            nPassword = null;
        } else {
	 ...
	 * @return KeyStore
	 */
	public static KeyStore getKsfilePath(String filepath, String strPassword)
			throws Exception {
		Security
				.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider());
     ...
     * @return 别名
     */
    public static String getAlsformPfx(String filepath, String strPassword)
            throws Exception {
