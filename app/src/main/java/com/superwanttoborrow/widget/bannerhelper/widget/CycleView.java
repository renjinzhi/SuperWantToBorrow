package com.superwanttoborrow.widget.bannerhelper.widget;
...
public class CycleView extends FrameLayout implements ViewPager.OnPageChangeListener{
    ...
    // 指示器图片，被选择状态
    private int mIndicatorSelected = R.drawable.dot_focus;
    // 指示器图片，未被选择状态
    private int mIndicatorUnselected = R.drawable.dot_normal;
    // 需要轮播的View集合
    ...
    // 轮播view默认占位图
    private Drawable defaultImage = getResources().getDrawable(R.mipmap.ic_launcher);
